...
<?php
    echo "Per Tanggal " . tgl(date('Y-m-d'));
    echo " " . $jam . "<br>";
?>

<p style="text-align: center">
    Nama : <?= $data->Nama_Operator; ?> | NIM : <?=  $data->NIM_Mahasiswa; ?>
</p>

  <table  align="center" width="75%" border="1px" cellspacing="0" cellpadding="3"> 
    <tbody>
        <tr>
          <td style="border: 1px solid black;"><b><font color="(#00CED1)">Positif</b></td>
          <td style="border: 1px solid black;"><b>Dirawat</b></td>
          <td style="border: 1px solid black;"><b><font color="(#7FFF00)">Sembuh</b></td>
